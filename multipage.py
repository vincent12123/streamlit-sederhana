...
def intro():
    ...
    st.markdown(
        """
        Halo siswa! Selamat datang di demo aplikasi Streamlit. Di sini, kita akan berkenalan dengan sebuah aplikasi multipage yang berisikan kasir sederhana. 
       Aplikasi ini sangat berguna bagi kita yang ingin belajar membuat aplikasi dengan bahasa pemrograman 
       Python dan framework Streamlit.
       
       **👈 Silahkan Pilih Demo dari Sidebar** untuk melihat contoh
        
        ### Aplikasi ini memungkinkan kita untuk memasukkan data pembelian seperti:
        - Nama Barang
        - harga
        - Jumlah Pembelian
